...
export const CARRIER_SENDERS: SenderRow[] = [
  ...
  { carrier: "transamerica", from_pattern: "noreply@email.transamerica.com", subject_pattern: null, email_type: "ignore", content_type: "body", route: "ignore", priority: 10, notes: "Bulk agent-update notices; no per-client data." },
  ...
  { carrier: "american_amicable", from_pattern: "noreply@aatx.com", subject_pattern: "^Policyholder Correspondence", email_type: "policyholder_correspondence", content_type: "body", route: "policy_tracker", priority: 25, notes: "Coded policyholder correspondence in body, e.g. 'Doc: ABDI2 BK DRFT RTN NSF W/AGT INFO' (bank draft returned NSF). Parser deciphers carrier shorthand into plain status. Covers American Amicable + Occidental Life." },
